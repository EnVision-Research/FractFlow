...
for obj_in_room in objects_in_room:
    if "style" in obj_in_room and "material" in obj_in_room:
        ...
        continue
    is_on_the_floor = 'on the floor' if obj_in_room['is_on_the_floor'] else 'not on the floor'
    text = preprocess("A high-poly, high quality " + obj_in_room['new_object_id']) + f" with {material} material and in {style} style, typically {is_on_the_floor} and suitable for indoor furniture"
