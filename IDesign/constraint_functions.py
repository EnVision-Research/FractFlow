...
def get_left_of_constraint(obj_A, obj_B, is_adjacent, is_on_floor, room_dimensions):
    """
    obj_A is left of obj_B, with minimum gap of 0.05 units
    """
    MIN_GAP = 0.05  # 最小间距
    ...
    if obj_B["rotation"]["z_angle"] == 0.0:
        x_min = obj_B["position"]["x"] - size_B["length"] / 2 - size_A["length"] / 2 - MIN_GAP if is_adjacent else size_A["length"] / 2
        x_max = obj_B["position"]["x"] - size_B["length"] / 2 - size_A["length"] / 2 - MIN_GAP
        ...
        y_min = obj_B["position"]["y"] + size_B["length"] / 2 + size_A["width"] / 2 + MIN_GAP
        y_max = obj_B["position"]["y"] + size_B["length"] / 2 + size_A["width"] / 2 + MIN_GAP if is_adjacent else room_dimensions[1] - size_A["width"] / 2
    elif obj_B["rotation"]["z_angle"] == 180.0:
        x_min = obj_B["position"]["x"] + size_B["length"] / 2 + size_A["length"] / 2 + MIN_GAP
        x_max = obj_B["position"]["x"] + size_B["length"] / 2 + size_A["length"] / 2 + MIN_GAP if is_adjacent else room_dimensions[0] - size_A["length"] / 2
        y_min = obj_B["position"]["y"] - size_B["width"] / 2 + ((is_adjacent * size_A["width"]) - (not is_adjacent * size_A["width"])) / 2
        y_max = obj_B["position"]["y"] + size_B["width"] / 2 - ((is_adjacent * size_A["width"]) - (not is_adjacent * size_A["width"])) / 2
    elif obj_B["rotation"]["z_angle"] == 270.0:
        x_min = obj_B["position"]["x"] - size_B["width"] / 2 + ((is_adjacent * size_A["length"]) - (not is_adjacent * size_A["length"])) / 2
        x_max = obj_B["position"]["x"] + size_B["width"] / 2 - ((is_adjacent * size_A["length"]) - (not is_adjacent * size_A["length"])) / 2
        y_min = obj_B["position"]["y"] - size_B["length"] / 2 - size_A["width"] / 2 - MIN_GAP if is_adjacent else size_A["width"] / 2
        y_max = obj_B["position"]["y"] - size_B["length"] / 2 - size_A["width"] / 2 - MIN_GAP
...
def get_right_of_constraint(obj_A, obj_B, is_adjacent, is_on_floor, room_dimensions):
    """
    obj_A is right of obj_B, with minimum gap of 0.05 units
    """
    MIN_GAP = 0.05  # 最小间距
    ...
    if obj_B["rotation"]["z_angle"] == 0.0:
        ...
        x_max = obj_B["position"]["x"] + size_B["width"] / 2 - ((is_adjacent * size_A["length"]) - (not is_adjacent * size_A["length"])) / 2
        y_min = obj_B["position"]["y"] - size_B["length"] / 2 - size_A["width"] / 2 - MIN_GAP
        y_max = obj_B["position"]["y"] - size_B["length"] / 2 - size_A["width"] / 2 - MIN_GAP if is_adjacent else size_A["width"] / 2
    elif obj_B["rotation"]["z_angle"] == 180.0:
        x_min = obj_B["position"]["x"] - size_B["length"] / 2 - size_A["length"] / 2 - MIN_GAP if is_adjacent else size_A["length"] / 2
        x_max = obj_B["position"]["x"] - size_B["length"] / 2 - size_A["length"] / 2 - MIN_GAP
        y_min = obj_B["position"]["y"] + size_B["width"] / 2 - ((is_adjacent * size_A["width"]) - (not is_adjacent * size_A["width"])) / 2
...
def get_in_front_constraint(obj_A, obj_B, is_adjacent, is_on_floor, room_dimensions):
    """
    obj_A is in front of obj_B, with minimum gap of 0.05 units
    """
    MIN_GAP = 0.05  # 最小间距
    ...
    if obj_B["rotation"]["z_angle"] == 0.0:
        ...
        y_min = obj_B["position"]["y"] + size_B["width"] / 2 + size_A["width"] / 2 + MIN_GAP
        y_max = obj_B["position"]["y"] + size_B["width"] / 2 + size_A["width"] / 2 + MIN_GAP if is_adjacent else room_dimensions[1] - size_A["width"] / 2
    elif obj_B["rotation"]["z_angle"] == 90.0:
        x_min = obj_B["position"]["x"] + size_B["width"] / 2 + size_A["length"] / 2 + MIN_GAP
        x_max = obj_B["position"]["x"] + size_B["width"] / 2 + size_A["length"] / 2 + MIN_GAP if is_adjacent else room_dimensions[0] - size_A["length"] / 2
        ...
        x_min = obj_B["position"]["x"] - size_B["length"] / 2 + ((is_adjacent * size_A["length"]) - (not is_adjacent * size_A["length"])) / 2
        x_max = obj_B["position"]["x"] + size_B["length"] / 2 - ((is_adjacent * size_A["length"]) - (not is_adjacent * size_A["length"])) / 2
        y_min = obj_B["position"]["y"] - size_B["width"] / 2 - size_A["width"] / 2 - MIN_GAP if is_adjacent else size_A["width"] / 2
        y_max = obj_B["position"]["y"] - size_B["width"] / 2 - size_A["width"] / 2 - MIN_GAP
    elif obj_B["rotation"]["z_angle"] == 270.0:
        x_min = obj_B["position"]["x"] - size_B["width"] / 2 - size_A["length"] / 2 - MIN_GAP if is_adjacent else size_A["length"] / 2
        x_max = obj_B["position"]["x"] - size_B["width"] / 2 - size_A["length"] / 2 - MIN_GAP
        y_min = obj_B["position"]["y"] - size_B["length"] / 2 + ((is_adjacent * size_A["width"]) - (not is_adjacent * size_A["width"])) / 2
        y_max = obj_B["position"]["y"] + size_B["length"] / 2 - ((is_adjacent * size_A["width"]) - (not is_adjacent * size_A["width"])) / 2
...
def get_behind_constraint(obj_A, obj_B, is_adjacent, is_on_floor, room_dimensions):
    """
    obj_A is behind obj_B, with minimum gap of 0.05 units
    """
    MIN_GAP = 0.05  # 最小间距
