...
def get_rotation(obj_A, scene_graph):
    ...
    if "facing" in obj_A.keys() and obj_A["facing"] == "middle of the room":
        if obj_A["placement"]["room_layout_elements"][0]["preposition"] == "on" and obj_A["placement"]["room_layout_elements"][0]["layout_element_id"] == "south_wall":
            return 0.0
        elif obj_A["placement"]["room_layout_elements"][0]["preposition"] == "on" and obj_A["placement"]["room_layout_elements"][0]["layout_element_id"] == "north_wall":
            return 180.0
        elif obj_A["placement"]["room_layout_elements"][0]["preposition"] == "on" and obj_A["placement"]["room_layout_elements"][0]["layout_element_id"] == "east_wall":
            return 270.0
        elif obj_A["placement"]["room_layout_elements"][0]["preposition"] == "on" and obj_A["placement"]["room_layout_elements"][0]["layout_element_id"] == "west_wall":
            return 90.0
...
def get_cluster_objects(scene_graph):
    ...
    for obj in scene_graph:
        print("Object: ", obj)
        # Don't add thin objects to the clusterprint
        ...
        if placement:
            ...
            print("Scene graph set: ", scene_graph_set)
...
def create_empty_image_with_boxes(image_size, boxes):
    ...
    output_path = "scene_visualization.png"
